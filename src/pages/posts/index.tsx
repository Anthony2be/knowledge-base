...
export default function Component() {
  ...
  return (
    <>
      ...
      <textarea cols={30} rows={10} onChange={(e) => setContent(e.target.value)} value={content} className="text-black"/>
      <button onClick={handleClick}>Create post</button>
      <div className="w-fit">
        <input type="text" onChange={(e) => setDeleteText(e.target.value)} value={deleteText} className="text-black"/>
